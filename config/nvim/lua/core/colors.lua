...
vim.cmd([[
  ...
  highlight CmpPmenuThumb             guibg=NONE ctermbg=NONE
  highlight CmpDocumentation          guibg=NONE ctermbg=NONE
  highlight CmpDocumentationBorder    guibg=NONE ctermbg=NONE
